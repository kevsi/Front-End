...
export const useDashboardStats = () => {
  return useQuery({
    ...
    queryFn: async () => {
      // En mode développement, retourner directement les données offline
      if (import.meta.env.DEV) {
        const { OFFLINE_DASHBOARD_STATS } = await import("@/lib/offline-data");
      ...
      // En production, utiliser l'API Laravel
    ...
    staleTime: import.meta.env.DEV ? Infinity : 30000,
  });
};
